...
class StartScene extends Scene {
    ...
    draw() {
        ...
        this.drawBG();
        this.drawTitle();
        // Draw anything else needed for start screen
    }
...
class Level1Scene extends Scene {
    ...
    init() {
        this.audios = Engine.loadAudios({
            songAction: {
                src: './audio/songAction.mp3',
                loop: true
            },
            fxGoal: {
                src: './audio/fxGoal.mp3',
                loop: false
            }
        });
    ...
    drawPlayer() {
        ctx.drawImage(heroImage, this.player.x, this.player.y, this.player.width, this.player.height)
    }
    ...
    draw() {
        ...
        this.goals.forEach(goal => {
            ctx.drawImage(goalImage, goal.x, goal.y, this.GOAL_SIZE, this.GOAL_SIZE);
        });
